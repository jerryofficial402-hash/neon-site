...
<head>
  ...
  <meta property="og:image" content="https://neonautotransport.com/images/car-transport-cost-guide-hero.jpg">
  ...
  <meta name="twitter:image" content="https://neonautotransport.com/images/car-transport-cost-guide-hero.jpg">
    ...
    <section class="bg-white border-b border-[#e6e6e6] py-12 lg:py-16">
      <div class="container mx-auto px-4 lg:px-8 max-w-4xl">
        ...
        <div class="mt-6 overflow-hidden rounded-3xl border border-[#e6e6e6] shadow-lg relative bg-[#0a2540]">
          <img src="/images/car-transport-cost-guide-hero.jpg" alt="Neon Auto Transport logistics specialist conducting pre-transport vehicle condition inspection with customer in front of auto transport carrier trucks - licensed FMCSA broker USDOT 4355879" class="w-full h-auto max-h-[500px] object-cover" width="1200" height="800" loading="eager" decoding="async">
    ...
    <section class="py-12 bg-[#f6f9fc]">
      <div class="container mx-auto px-4 lg:px-8 max-w-4xl">
        <div class="bg-white p-8 md:p-12 rounded-3xl border border-[#e6e6e6] shadow-sm space-y-10 text-[#425466] leading-relaxed font-normal text-base">
          ...
          <!-- Section 6: Verification (RESTRUCTURED CLEAN CARD LAYOUT) -->
          <div>
            <h2 class="text-2xl md:text-3xl font-black text-[#0a2540] mb-4 tracking-tight">
            ...
            <div class="space-y-4">
              <div class="p-5 bg-[#f6f9fc] rounded-2xl border border-[#e6e6e6] flex items-start gap-3">
                ...
                <div class="text-sm leading-relaxed text-[#425466]">
                  <strong class="text-[#0a2540]">Active FMCSA &amp; USDOT Licensing:</strong> Ask any broker for their license number before booking. Neon Auto Transport's USDOT number is <strong class="text-[#0a2540]">4355879</strong> (MC #1703787), searchable directly on the official FMCSA SAFER system.
                </div>
              </div>
              ...
              <div class="p-5 bg-[#f6f9fc] rounded-2xl border border-[#e6e6e6] flex items-start gap-3">
                <span class="w-6 h-6 rounded-full bg-[#39FF14]/20 text-[#0a2540] font-black flex items-center justify-center text-xs flex-shrink-0 mt-0.5">✓</span>
                <div class="text-sm leading-relaxed text-[#425466]">
                  <strong class="text-[#0a2540]">Zero Upfront Deposit:</strong> Never pay a single dollar before a vetted carrier is officially assigned and dispatched to your vehicle.
                </div>
              </div>
              ...
              <div class="p-5 bg-[#f6f9fc] rounded-2xl border border-[#e6e6e6] flex items-start gap-3">
                <span class="w-6 h-6 rounded-full bg-[#39FF14]/20 text-[#0a2540] font-black flex items-center justify-center text-xs flex-shrink-0 mt-0.5">✓</span>
                <div class="text-sm leading-relaxed text-[#425466]">
                  <strong class="text-[#0a2540]">Included Cargo Insurance:</strong> Verify that active motor carrier cargo coverage ($100,000–$500,000) is provided for your shipment.
                </div>
              </div>
            </div>
          </div>
...
print(f"SUCCESS: Rebuilt Car Transport Cost Guide pillar page with clean card layout at {target_file}")
