...
<head>
  ...
  <title>Florida to Virginia Car Shipping | Neon Auto Transport</title>
  <meta name="description" content="Ship a car from Florida to Virginia for $650–$1,150. 2–4 day transit, $500K insurance, no deposit. Get an instant quote from Neon Auto Transport.">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="https://neonautotransport.com/florida-to-virginia-car-shipping/">
  ...
  [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Florida to Virginia Car Shipping", "item": "https://neonautotransport.com/florida-to-virginia-car-shipping/" }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Florida to Virginia Car Shipping",
      "provider": {
        "@type": "MovingCompany",
  ...
  <main class="pt-24">
    <section class="bg-[#0a2540] text-white py-12 md:py-16">
      <div class="container mx-auto px-4 lg:px-8 max-w-4xl text-center space-y-4">
        <h1 class="text-3xl md:text-5xl font-black">Florida to Virginia Car Shipping</h1>
        <p class="text-base text-[#8ba3ba] max-w-2xl mx-auto">
          Ship your vehicle north from Florida to Virginia for <strong>$650–$1,150</strong> with 2–4 day transit, $500K cargo insurance, and $0 upfront deposit.
        </p>
      </div>
    </section>
    ...
    <section class="container mx-auto px-4 lg:px-8 max-w-4xl py-12">
      <div class="bg-white p-6 md:p-8 rounded-3xl border border-[#e6e6e6] space-y-6 text-sm text-[#425466]">
        <h2 class="text-2xl font-black text-[#0a2540]">Northbound Florida to Virginia Car Shipping</h2>
        <p>Spring snowbird migration (April–May) sees heavy northbound demand as seasonal residents return from Miami, Tampa, and Orlando to Northern Virginia, Richmond, and Hampton Roads.</p>
        
        <div class="p-4 bg-[#f6f9fc] rounded-2xl border-l-4 border-l-[#635bff]">
          <h3 class="font-bold text-[#0a2540] mb-1">Looking for Southbound Shipping or Out-of-State Car Delivery?</h3>
          <p class="text-xs">
            View our master guide for <a href="/virginia-to-florida-car-shipping/" class="text-[#635bff] font-bold hover:underline">Virginia to Florida Car Delivery (Southbound) &rarr;</a>
          </p>
        </div>
      </div>
    </section>
