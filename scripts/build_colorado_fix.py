...
if col_span_2:
    ...
    # Extract children and extend properly
    inner_div = new_soup.find('div', class_='space-y-12')
    # Using contents list so it evaluates before modifying
    for child in list(inner_div.children):
