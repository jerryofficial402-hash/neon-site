...
<body class="bg-[#f6f9fc] text-[#425466] font-sans antialiased">
  <!-- Global Header -->
  <header class="bg-[#0a2540] text-white sticky top-0 z-50 shadow-md" id="global-header">
    <div class="container mx-auto px-4 lg:px-8 max-w-7xl h-20 flex items-center justify-between">
      <a href="/" class="flex items-center gap-2 font-black text-xl text-[#00D1FF] tracking-tight" style="text-decoration: none;" id="logo-text">
        <span>NEON</span><span class="text-white text-xs font-normal">AUTO TRANSPORT</span>
      </a>
      <nav class="hidden lg:flex items-center gap-6 text-sm font-semibold text-[#cdd5df]">
      ...
      <div class="hidden lg:flex items-center gap-4">
        <a href="tel:5715767711" class="flex items-center gap-2 bg-[#ffc72c] text-[#0a2540] px-4 py-2 rounded-full font-black text-xs hover:bg-[#e6b320] transition" style="text-decoration: none;">
  ...
  <section class="relative stripe-gradient-bg overflow-hidden bg-[#0a2540] text-white" style="padding-top:140px;padding-bottom:120px;clip-path:polygon(0 0,100% 0,100% 88%,0 100%)">
    <div class="container mx-auto px-4 lg:px-8 z-10 relative text-center max-w-4xl">
      <nav aria-label="Breadcrumbs" class="flex justify-center items-center gap-2 text-xs font-semibold mb-4 flex-wrap text-slate-300">
        <a href="/" class="hover:underline text-slate-300">Home</a><span>/</span> <span class="text-white font-bold">Vehicle Transport Services</span>
      </nav>
  ...
  <main class="pb-24">
    ...
    <div class="container mx-auto px-4 lg:px-8 max-w-6xl relative z-20" style="margin-top:-60px">
      ...
      <div class="p-8 md:p-12 bg-[#f8fafc] rounded-3xl border border-[#e6e6e6] shadow-sm mb-20">
