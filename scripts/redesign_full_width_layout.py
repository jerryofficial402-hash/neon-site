...
# Modern Full-Width Multi-Column Layout for California to Texas Enclosed Route
route_main_body = """    <!-- Main Content Body (Full-Width Modular Layout) -->
    <div class="container mx-auto px-4 lg:px-8 max-w-7xl mt-12 mb-24 space-y-16">
      
      <!-- Section 1: Overview & Key Facts (2-Column Split) -->
      <section class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <!-- Left: Answer-First Intro Card -->
        <div class="lg:col-span-6 bg-white p-8 lg:p-10 rounded-2xl shadow-xl border border-[#e6e6e6]">
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#e0f2fe] text-[#0369a1] text-xs font-bold uppercase tracking-wider mb-4">
            <span class="w-2 h-2 rounded-full bg-[#0369a1]"></span> Route Summary
          </div>
          <h2 class="text-2xl lg:text-3xl font-black text-[#0a2540] mb-4">Enclosed Car Shipping California to Texas Overview</h2>
        ...
        <div class="lg:col-span-6 bg-white p-8 lg:p-10 rounded-2xl shadow-xl border border-[#e6e6e6]">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div class="p-[#f8fafc] p-4 bg-[#f8fafc] rounded-xl border border-[#e2e8f0]">
      ...
      <!-- Section 2: Pricing & City Routes (2-Column Split Tables) -->
      <section class="bg-white p-8 lg:p-12 rounded-2xl shadow-xl border border-[#e6e6e6]">
        <div class="mb-8">
          <h2 class="text-3xl font-black text-[#0a2540] mb-3">Enclosed Car Shipping California to Texas Cost — 2026 Pricing</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="space-y-4">
            ...
            <div class="overflow-x-auto rounded-xl border border-[#e6e6e6] shadow-sm">
      ...
      <!-- Section 3: Route Details & Seasonal Trends (2-Column Alternating) -->
      <section class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        <!-- Left: Highway Details Card -->
        <div class="lg:col-span-6 bg-white p-8 lg:p-10 rounded-2xl shadow-xl border border-[#e6e6e6] flex flex-col justify-between">
          <div>
      ...
      <!-- Section 4: Why Enclosed + Enclosed vs Open Comparison (2-Column) -->
      <section class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <!-- Left: Vehicle Eligibility List -->
        <div class="lg:col-span-5 bg-white p-8 lg:p-10 rounded-2xl shadow-xl border border-[#e6e6e6]">
        ...
        <div class="lg:col-span-7 bg-white p-8 lg:p-10 rounded-2xl shadow-xl border border-[#e6e6e6]">
          <h2 class="text-2xl font-black text-[#0a2540] mb-4">Enclosed vs. Open Transport — CA to TX</h2>
          <div class="overflow-x-auto rounded-xl border border-[#e6e6e6] shadow-sm mb-4">
            <table class="w-full text-left border-collapse text-sm">
              <thead>
                <tr class="bg-[#f6f9fc] border-b border-[#e6e6e6]">
      ...
      <!-- Section 5: Documents & Preparation (2-Column Split) -->
      <section class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      ...
      <!-- Section 6: Why Choose Neon (3-Column Feature Grid) -->
      <section class="bg-white p-8 lg:p-12 rounded-2xl shadow-xl border border-[#e6e6e6]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="p-6 bg-[#f8fafc] rounded-xl border border-[#e2e8f0] flex flex-col justify-between">
            <div>
      ...
      <section class="bg-[#f8fafc] p-8 lg:p-12 rounded-2xl border border-[#e6e6e6]">
        <div class="text-center max-w-3xl mx-auto mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="bg-white p-6 rounded-xl border border-[#e6e6e6]">
      ...
      <section class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        <div class="lg:col-span-6 bg-white p-8 rounded-xl border border-[#e6e6e6]">
        ...
        <div class="lg:col-span-6 bg-white p-8 rounded-xl border border-[#e6e6e6] flex items-center gap-4">
...
route_content = re.sub(
    r'<!-- Main Content Body -->\s*<section class="container mx-auto px-4 lg:px-8 max-w-6xl mt-12 mb-24">.*?</section>',
    route_main_body,
    route_content,
    flags=re.DOTALL
)
...
print("SUCCESS: Updated routes/california-to-texas-enclosed/index.html to full-width 2-column modular layout!")
