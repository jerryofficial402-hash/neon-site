...
REVERSE_TARGET = os.path.join(SITE_DIR, "florida-to-north-carolina-car-shipping", "index.html")

fl_to_nc_html = """<!DOCTYPE html>
<html lang="en">
<head>
  <!-- Google Tag Manager -->
  ...
  <title>Florida to North Carolina Car Shipping | Neon Auto Transport</title>
  <meta name="description" content="Ship a car from Florida to North Carolina for $500–$1,050. 1–4 day transit, $500K insurance, no deposit. Get an instant quote from Neon Auto Transport.">
  <meta name="robots" content="index, follow">
  <link rel="canonical" href="https://neonautotransport.com/florida-to-north-carolina-car-shipping/">
  ...
  [
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Florida to North Carolina Car Shipping", "item": "https://neonautotransport.com/florida-to-north-carolina-car-shipping/" }
      ]
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "name": "Florida to North Carolina Car Shipping",
      "provider": {
        "@type": "MovingCompany",
        "name": "Neon Auto Transport",
        "url": "https://neonautotransport.com",
        "telephone": "(571) 576-7711",
  ...
  <main class="pt-24">
    ...
    <section class="bg-[#0a2540] text-white py-12 md:py-16">
      <div class="container mx-auto px-4 lg:px-8 max-w-4xl text-center space-y-4">
        <h1 class="text-3xl md:text-5xl font-black">Florida to North Carolina Car Shipping</h1>
        <p class="text-base text-[#8ba3ba] max-w-2xl mx-auto">
          Ship your vehicle north from Florida to North Carolina for <strong>$500–$1,050</strong> with 1–4 day transit, $500K cargo insurance, and $0 upfront deposit.
        </p>
      </div>
    </section>
    ...
    <section class="container mx-auto px-4 lg:px-8 max-w-4xl py-12">
      <div class="bg-white p-6 md:p-8 rounded-3xl border border-[#e6e6e6] space-y-6 text-sm text-[#425466]">
        <h2 class="text-2xl font-black text-[#0a2540]">Northbound Florida to North Carolina Transport</h2>
        <p>Spring snowbird migration (April–June) sees high demand northbound as residents return to North Carolina from Florida winter homes. Book early to lock in your preferred pickup dates.</p>
        
        <div class="p-4 bg-[#f6f9fc] rounded-2xl border-l-4 border-l-[#635bff]">
          <h3 class="font-bold text-[#0a2540] mb-1">Looking for Southbound Shipping?</h3>
          <p class="text-xs">
            Check our master guide for <a href="/north-carolina-to-florida-car-shipping/" class="text-[#635bff] font-bold hover:underline">North Carolina to Florida Car Shipping (Southbound) &rarr;</a>
          </p>
        </div>
      </div>
    </section>
...
with open(REVERSE_TARGET, "w", encoding="utf-8") as f:
    f.write(fl_to_nc_html)

print("SUCCESS: Built Reverse Route Page for Florida to North Carolina Car Shipping!")
