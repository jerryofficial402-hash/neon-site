    ...
    <div class="container mx-auto px-4 lg:px-8 max-w-5xl relative z-20" style="margin-top:-60px">
      ...
      <div class="p-8 md:p-10 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12">
        ...
        <div class="grid md:grid-cols-2 gap-4 text-xs font-semibold text-[#0a2540] mb-6">
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl">✅ Authorized Auto Transport Broker — MC #1703787, USDOT #4355879</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl">✅ Carrier Matching — We review carrier availability, FMCSA registration, and insurance information before dispatch</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl">✅ Route-Specific Quoting — Clear upfront pricing tailored to your route</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl">✅ Door-to-Door Coordination — Pickup and delivery as close to your location as access permits</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl">✅ Bill of Lading Support — Vehicle condition inspection guidance at pickup & delivery</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl">✅ Shipment Support — Customer assistance throughout the transport process</div>
        </div>
      </div>
      ...
      <div class="p-8 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 overflow-x-auto">
