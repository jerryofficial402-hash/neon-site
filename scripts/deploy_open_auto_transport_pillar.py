    ...
    "@graph": [
      ...
      },
      {
        ...
        "mainEntity": [
          ...
          {
            "@type": "Question",
            "name": "Can I choose the carrier that transports my vehicle?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Neon coordinates carrier assignment based on route, availability, vehicle requirements, scheduling, and applicable carrier information. Customers can discuss available carrier options with their transport specialist before dispatch."
            }
          },
          {
            "@type": "Question",
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Open transport carries vehicles on an uncovered trailer exposed to normal weather and road conditions. Enclosed transport uses a covered trailer for added protection against weather and road debris."
            }
          }
        ]
      }
...
<body class="bg-[#f6f9fc] text-[#425466] font-sans antialiased">
            ...
            <div class="absolute left-1/2 transform -translate-x-1/2 mt-2 w-[900px] bg-white rounded-xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] border border-[#e6e6e6] p-8 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 translate-y-4 group-hover:translate-y-0 z-50 text-left" style="top:100%">
              <div class="grid grid-cols-3 gap-10 text-sm">
                ...
                <div>
                  ...
                  <ul class="space-y-4 mt-4 text-[#425466] font-medium" style="list-style:none; padding:0;">
                    <li><a href="/car-shipping-quote/" class="hover:text-[#4338ca] flex items-center justify-between group/link">Specialized Shipping Quote <span class="text-[#00d4ff] text-[10px]">▶</span></a></li>
                  </ul>
                </div>
              </div>
            </div>
  ...
  <!-- Perfectly Aligned & Proportionate Hero Section -->
    ...
    <div class="container mx-auto px-4 lg:px-8 max-w-6xl">
      <div class="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        <div class="lg:col-span-7 flex flex-col justify-center text-left">
          <nav aria-label="Breadcrumbs" class="flex items-center gap-2 text-xs font-semibold flex-wrap text-[#425466] mb-3">
          ...
          <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#e6e6e6] bg-white shadow-sm text-[#0a2540] text-xs font-bold mb-4 self-start">
            <span class="w-2 h-2 rounded-full bg-[#39FF14]"></span>
            Authorized Broker • USDOT #4355879 • MC #1703787
          </div>

          <h1 class="text-3xl sm:text-4xl lg:text-5xl font-black text-[#0a2540] mb-4 tracking-tight leading-tight">
            Open Auto Transport: <br class="hidden sm:inline"/><span class="text-[#00D1FF]">Nationwide Car Shipping</span>
          </h1>

          <p class="text-base text-[#425466] mb-4 leading-relaxed font-normal">
          ...
          <p class="text-xs text-[#425466] mb-6 leading-relaxed font-medium">
            Neon Auto Transport LLC is an authorized auto transport broker. We arrange transportation through independently owned motor carriers. Request a free quote to compare available open-carrier options for your route.
          </p>

          <div class="flex flex-wrap items-center gap-4">
            <a href="/car-shipping-quote/" class="bg-[#39FF14] text-[#0a2540] px-7 py-3.5 rounded-full font-black text-base hover:bg-[#32e011] transition shadow-[0_0_15px_rgba(57,255,20,0.4)] flex items-center gap-2" style="text-decoration: none;">
              Get Your Free Quote 
            ...
            <a href="tel:5715767711" class="px-6 py-3.5 rounded-full font-extrabold text-base bg-white text-[#0a2540] border border-[#e6e6e6] shadow-sm hover:bg-[#f8fafc] transition flex items-center gap-2" style="text-decoration: none;">
        ...
        <!-- Right Column: Perfectly Proportioned Hero Image Showcase Card -->
        <div class="lg:col-span-5 relative w-full">
          <div class="relative rounded-2xl overflow-hidden shadow-xl border border-black/5 bg-white p-2 card-hover-cyan">
            <img src="/images/open-auto-transport-hero.jpg" alt="Modern open multi-car auto transport truck shipping cars on nationwide highway" class="w-full h-auto rounded-xl object-cover" decoding="async" fetchpriority="high" height="675" loading="eager" width="1200" style="max-height: 320px;">
            <div class="p-3 bg-[#f8fafc] rounded-lg border border-[#e6e6e6] mt-2 text-xs text-[#0a2540] font-semibold flex items-center justify-between">
              <span>🚛 Standard Open Multi-Car Carrier</span>
              <span class="text-[#635bff]">Door-to-Door Service</span>
            </div>
          </div>
        </div>
  ...
  <!-- Main Body Container -->
  <main class="pb-24">
    <div class="container mx-auto px-4 lg:px-8 max-w-5xl relative z-20 pt-10">
      ...
      <div class="p-8 md:p-10 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 card-hover-cyan">
        ...
        <div class="grid md:grid-cols-2 gap-4 text-xs font-semibold text-[#0a2540] mb-6">
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-indigo">✅ Authorized Auto Transport Broker — MC #1703787, USDOT #4355879</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-cyan">✅ Carrier Matching — We review carrier availability, FMCSA registration, and insurance information before dispatch</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-indigo">✅ Route-Specific Quoting — Clear upfront pricing tailored to your route</div>
      ...
      <div class="p-8 md:p-10 bg-[#f8fafc] rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 card-hover-indigo">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-3 text-xs font-semibold text-[#0a2540] mb-6">
          <div class="p-3 bg-white border border-[#e6e6e6] rounded-xl card-hover-cyan">🚗 Daily drivers & sedans</div>
          <div class="p-3 bg-white border border-[#e6e6e6] rounded-xl card-hover-indigo">🚙 Family SUVs & crossovers</div>
          <div class="p-3 bg-white border border-[#e6e6e6] rounded-xl card-hover-cyan">🛻 Pickup trucks & vans</div>
          <div class="p-3 bg-white border border-[#e6e6e6] rounded-xl card-hover-indigo">🏢 Dealer inventory & fleet moves</div>
          <div class="p-3 bg-white border border-[#e6e6e6] rounded-xl card-hover-cyan">💻 Vehicles purchased online</div>
          <div class="p-3 bg-white border border-[#e6e6e6] rounded-xl card-hover-indigo">📦 Relocation & military moves</div>
        </div>
        ...
        <table class="w-full text-left text-sm border-collapse mb-6 min-w-[500px]">
          ...
          <tbody class="divide-y divide-[#e6e6e6] bg-[#f8fafc]">
            ...
            <tr>
              ...
              <td class="p-4">Greater protection from weather & road debris</td>
            </tr>
            <tr>
      ...
      <div class="p-8 md:p-10 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 card-hover-indigo">
        ...
        <div class="grid sm:grid-cols-2 gap-4 text-xs font-semibold text-[#0a2540]">
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-cyan">📍 Narrow residential streets or tight corners</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-indigo">🌳 Low-hanging tree branches or power lines</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-cyan">🏔️ Steep driveways or unpaved rural roads</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-indigo">🚧 Gated communities or security weight limits</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-cyan">🔄 Cul-de-sacs without adequate turning radius</div>
          <div class="p-4 bg-[#f8fafc] border border-[#e6e6e6] rounded-xl card-hover-indigo">🅿️ Municipal parking or truck idling restrictions</div>
        </div>
        
        <div class="mt-6 p-4 bg-[#f6f9fc] border border-[#e6e6e6] rounded-xl text-xs text-[#425466] leading-relaxed">
          <strong class="text-[#0a2540] block mb-1">What Happens If the Carrier Can't Reach My Address?</strong>
      ...
      <div class="p-8 md:p-10 bg-[#f8fafc] rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 card-hover-cyan">
        ...
        <div class="space-y-4 text-xs text-[#425466] leading-relaxed">
          <div class="p-4 bg-white border border-[#e6e6e6] rounded-xl card-hover-indigo">
          ...
          <div class="p-4 bg-white border border-[#e6e6e6] rounded-xl card-hover-cyan">
      ...
      <div class="p-8 md:p-10 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 card-hover-indigo">
        ...
        <ul class="space-y-3 text-base text-[#425466] pl-5 list-disc mb-6">
          ...
          <li>Keep the fuel level within the amount requested by your carrier or transport coordinator.</li>
      ...
      <div class="p-8 md:p-10 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 card-hover-cyan">
        ...
        <div class="space-y-6 max-w-3xl mx-auto">
          ...
          <div class="border-b border-[#e6e6e6] pb-6">
            <h3 class="text-lg font-bold text-[#0a2540] mb-2">Can I choose the carrier that transports my vehicle?</h3>
            <p class="text-sm text-[#425466] leading-relaxed">
      ...
      <div class="p-8 bg-white rounded-3xl border border-[#e6e6e6] shadow-sm mb-12 overflow-x-auto card-hover-indigo">
        <h2 class="text-2xl font-black text-[#0a2540] mb-4 tracking-tight">Open Auto Transport on Popular Routes</h2>
        <p class="text-base text-[#425466] leading-relaxed mb-6">
          Open carrier availability is commonly strong on major interstate corridors. Explore popular routes below or use the <a href="/cost-calculator/" class="text-[#635bff] font-bold hover:underline">Car Shipping Cost Calculator</a>:
        </p>

        <table class="w-full text-left text-xs border-collapse mb-4 min-w-[500px]">
          <thead>
            <tr class="bg-[#0a2540] text-white">
              <th class="p-3 rounded-tl-xl font-bold">Popular Route Corridor</th>
              <th class="p-3 font-bold">Transport Service</th>
              <th class="p-3 rounded-tr-xl font-bold">Route Link</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-[#e6e6e6] bg-[#f8fafc]">
            <tr>
              <td class="p-3 font-bold text-[#0a2540]">California ↔ Texas</td>
...
print("SUCCESS: Deployed perfectly proportioned & aligned Hero Section to Open Auto Transport!")
