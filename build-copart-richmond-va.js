...
// Add contact.html card hover CSS
const customCss = `
  <style>
    .card-hover-indigo {
...
// ============================================================
// 2. MAIN CONTENT STYLED LIKE CONTACT.HTML BOXES
// ============================================================
const newMain = `<main class="bg-white min-h-screen text-[#0a2540]">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 space-y-24 lg:space-y-32">
      ...
      <!-- 2. Why Choose Neon Section (Styled Exactly Like Contact Cards) -->
      <section class="pt-4">
      ...
      <section class="pt-4">
        ...
        <div class="space-y-6">
          <div class="bg-white p-7 rounded-2xl card-hover-indigo flex gap-5 sm:gap-6 items-start" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">Pay your Copart invoice in full using wire transfer, ePay, or debit. Copart will not release any vehicle until funds clear.</p>
            </div>
          </div>
          ...
          <div class="bg-white p-7 rounded-2xl card-hover-indigo flex gap-5 sm:gap-6 items-start" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">Log into your Copart Member portal. Download the Gate Pass / Buyer Release PIN and confirm whether your vehicle is at the Sandston or Charles City yard.</p>
            </div>
          </div>
          ...
          <div class="bg-white p-7 rounded-2xl card-hover-indigo flex gap-5 sm:gap-6 items-start" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">Provide your Lot #, Gate PIN, vehicle condition (operable, rolls/steers, or immobile), and delivery address. We assign an FMCSA-authorized carrier.</p>
            </div>
          </div>
          ...
          <div class="bg-white p-7 rounded-2xl card-hover-indigo flex gap-5 sm:gap-6 items-start" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">The driver schedules an arrival window via the Copart Transportation App, inspects the vehicle (Bill of Lading), and safely loads it via ramp, winch, or forklift.</p>
            </div>
          </div>
          ...
          <div class="bg-white p-7 rounded-2xl card-hover-indigo flex gap-5 sm:gap-6 items-start" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">Your vehicle is delivered directly to your home, auto repair shop, dealership, or shipping port with full cargo insurance coverage.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- 5. Yard Locations Section (EXACT MATCH to Contact Page Location Cards) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <!-- Yard 1: Sandston (Woodbridge Style) -->
          <div class="bg-white p-8 rounded-3xl card-hover-indigo flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            <div>
              <div class="inline-flex items-center gap-2 px-3 py-1 bg-[#e0e7ff] text-[#4338ca] text-xs font-bold rounded-full mb-4">
          ...
          <!-- Yard 2: Charles City (Live Oak Style) -->
          <div class="bg-white p-8 rounded-3xl card-hover-cyan flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            <div>
              <div class="inline-flex items-center gap-2 px-3 py-1 bg-[#ecfeff] text-[#0891b2] text-xs font-bold rounded-full mb-4">
      ...
      <!-- 6. Vehicle Conditions Section (Styled Cards) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
      ...
      <!-- 7. Delivery Routes Grid (Styled Cards) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
      ...
      <section class="pt-4" itemscope itemtype="https://schema.org/FAQPage">
        ...
        <div class="space-y-5">
          <details class="bg-white p-7 rounded-2xl card-hover-indigo group cursor-pointer" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" open>
          ...
          <details class="bg-white p-7 rounded-2xl card-hover-indigo group cursor-pointer" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1rem;" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            <summary class="font-bold text-[#0a2540] text-base sm:text-lg flex justify-between items-center list-none">
...
console.log('✅ Generated exact contact.html-style boxes for Copart Richmond page.');
