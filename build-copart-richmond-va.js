...
// ============================================================
// 2. POLISHED, BEAUTIFULLY STRUCTURED BOXES & PROPER CTAS
// ============================================================
const newMain = `<main class="bg-white min-h-screen">
    ...
    <!-- Main Content Flow with Proper Spacing -->
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 space-y-24 lg:space-y-32">
      
      <!-- 1. Quick Overview Box -->
      <section class="border border-slate-200 border-l-4 border-l-[#635bff] bg-slate-50 p-7 sm:p-9 rounded-2xl transition-all duration-300 hover:shadow-md hover:border-slate-300 hover:-translate-y-0.5" aria-label="Quick Summary">
        ...
        <div class="flex items-center gap-3 pt-3 border-t border-slate-200/80">
          <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:text-[#534be8] inline-flex items-center gap-1">
            Calculate your exact route rate &rarr;
          </a>
        </div>
      </section>

      <!-- 2. Why Choose Neon Section (Proper Card Design with Clean Footers) -->
      <section class="pt-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            ...
            <div class="pt-5 border-t border-slate-100 flex items-center justify-between">
              <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-50 text-[11px] font-semibold text-slate-700 border border-slate-200">
                <span class="w-1.5 h-1.5 rounded-full bg-[#16a34a]"></span> App Verified
              </span>
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline inline-flex items-center gap-0.5">
                Quote &rarr;
              </a>
            </div>
          </div>
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            ...
            <div class="pt-5 border-t border-slate-100 flex items-center justify-between">
              <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-50 text-[11px] font-semibold text-slate-700 border border-slate-200">
                <span class="w-1.5 h-1.5 rounded-full bg-[#16a34a]"></span> 24–48h Match
              </span>
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline inline-flex items-center gap-0.5">
                Quote &rarr;
              </a>
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            ...
            <div class="pt-5 border-t border-slate-100 flex items-center justify-between">
              <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-slate-50 text-[11px] font-semibold text-slate-700 border border-slate-200">
                <span class="w-1.5 h-1.5 rounded-full bg-[#16a34a]"></span> Winch Ready
              </span>
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline inline-flex items-center gap-0.5">
                Quote &rarr;
              </a>
      ...
      <!-- 3. How to Ship (5 Steps Structured Stack) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
      ...
      <!-- 4. Pricing Matrix Section with Table -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
        ...
        <div class="border border-slate-200 rounded-2xl bg-white p-6 sm:p-8 transition-all duration-300 hover:shadow-md">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
            <p class="text-xs text-slate-500">Note: Copart charges an additional $50–$75 gate/loading fee paid directly to the auction facility.</p>
            <a href="/cost-calculator/" style="background-color: #635bff; color: #ffffff;" class="px-5 py-2.5 rounded-lg text-xs font-bold hover:bg-[#534be8] transition whitespace-nowrap shadow-sm">
              Calculate Your Route Rate &rarr;
            </a>
          </div>
        </div>
      </section>

      <!-- 5. Yard Locations Section (Polished Structured Cards with Proper Action Buttons) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              <div class="flex items-center justify-between mb-5">
                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-800 text-xs font-bold uppercase tracking-wide">
                  <span class="w-1.5 h-1.5 rounded-full bg-[#16a34a]"></span> Primary Facility
                </span>
                <span class="text-xs font-bold text-slate-500 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-md">Yard #42</span>
              </div>

              <h3 class="text-xl sm:text-2xl font-bold text-[#0a2540] mb-4">Copart – Richmond (Sandston)</h3>
              ...
              <div class="space-y-3 mb-6 text-sm text-slate-600">
                <div class="flex items-start gap-2.5">
                  ...
                  <span>5701 Whiteside Rd, Sandston, VA 23150</span>
                </div>
                <div class="flex items-center gap-2.5">
                  <svg class="w-4 h-4 text-slate-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                  <span>Phone: <a href="tel:8043281023" class="text-[#635bff] font-semibold hover:underline">(804) 328-1023</a></span>
                </div>
                <div class="flex items-start gap-2.5">
                  <svg class="w-4 h-4 text-slate-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                  <span>Mon–Fri: 8:00 AM – 5:00 PM EST <span class="text-xs text-slate-400">(Gate cutoff: 4:30 PM)</span></span>
                </div>
              </div>
            </div>

            <div class="pt-5 border-t border-slate-100 flex flex-col sm:flex-row items-center gap-3">
              <a href="tel:8043281023" style="background-color: #0a2540; color: #ffffff;" class="w-full sm:w-1/2 py-2.5 px-4 rounded-xl text-xs font-bold text-center hover:bg-[#163a5f] transition flex items-center justify-center gap-1.5 shadow-sm">
              ...
              <a href="https://maps.google.com/?q=5701+Whiteside+Rd,+Sandston,+VA+23150" target="_blank" rel="noopener noreferrer" class="w-full sm:w-1/2 py-2.5 px-4 rounded-xl text-xs font-semibold text-slate-700 bg-slate-50 border border-slate-200 hover:bg-slate-100 transition text-center flex items-center justify-center gap-1">
                Open in Maps ↗
              </a>
            </div>
          </div>
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              <div class="flex items-center justify-between mb-5">
                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-800 text-xs font-bold uppercase tracking-wide">
                  <span class="w-1.5 h-1.5 rounded-full bg-[#0284c7]"></span> East Facility
                </span>
                <span class="text-xs font-bold text-slate-500 bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-md">Yard #134</span>
              </div>

              <h3 class="text-xl sm:text-2xl font-bold text-[#0a2540] mb-4">Copart – Richmond East (Charles City)</h3>
              
              <!-- Iconized Info Rows -->
              <div class="space-y-3 mb-6 text-sm text-slate-600">
                <div class="flex items-start gap-2.5">
                  <svg class="w-4 h-4 text-slate-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                  <span>6300 Chambers Road, Charles City, VA 23030</span>
                </div>
                <div class="flex items-center gap-2.5">
                  <svg class="w-4 h-4 text-slate-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                  <span>Phone: <a href="tel:8048299160" class="text-[#635bff] font-semibold hover:underline">(804) 829-9160</a></span>
                </div>
                <div class="flex items-start gap-2.5">
                  <svg class="w-4 h-4 text-slate-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                  <span>Mon–Fri: 8:00 AM – 5:00 PM EST <span class="text-xs text-slate-400">(Heavy loaders on site)</span></span>
                </div>
              </div>
            </div>

            <div class="pt-5 border-t border-slate-100 flex flex-col sm:flex-row items-center gap-3">
              <a href="tel:8048299160" style="background-color: #0a2540; color: #ffffff;" class="w-full sm:w-1/2 py-2.5 px-4 rounded-xl text-xs font-bold text-center hover:bg-[#163a5f] transition flex items-center justify-center gap-1.5 shadow-sm">
                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"/></svg>
                Call Yard Direct
              </a>
              <a href="https://maps.google.com/?q=6300+Chambers+Road,+Charles+City,+VA+23030" target="_blank" rel="noopener noreferrer" class="w-full sm:w-1/2 py-2.5 px-4 rounded-xl text-xs font-semibold text-slate-700 bg-slate-50 border border-slate-200 hover:bg-slate-100 transition text-center flex items-center justify-center gap-1">
                Open in Maps ↗
              </a>
            </div>
          </div>
      ...
      <!-- 6. Vehicle Conditions Section (Structured Comparison Cards) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              <div class="w-10 h-10 rounded-xl bg-slate-100 text-[#0a2540] flex items-center justify-center font-bold mb-5">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
              </div>
              <h3 class="font-bold text-lg text-[#0a2540] mb-2">Runs &amp; Drives</h3>
              <p class="text-sm text-slate-600 leading-relaxed mb-6">
                Starts and drives under its own power. Loaded onto standard open multi-car haulers via steel ramps.
              </p>
            </div>
            <div class="pt-5 border-t border-slate-100 flex items-center justify-between">
              <span class="text-xs font-semibold text-slate-700 bg-slate-100 px-3 py-1 rounded-md">Standard Ramp Haul</span>
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline">Select &rarr;</a>
            </div>
          </div>
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              ...
              <h3 class="font-bold text-lg text-[#0a2540] mb-2">Rolls &amp; Steers (Inoperable)</h3>
              <p class="text-sm text-slate-600 leading-relaxed mb-6">
                Non-running engine or mechanical issue, but tires hold air and steering functions. Loaded via 12,000 lb electric winch.
              </p>
            </div>
            <div class="pt-5 border-t border-slate-100 flex items-center justify-between">
              <span class="text-xs font-semibold text-[#635bff] bg-slate-100 px-3 py-1 rounded-md">Winch Load (+ $100–$250)</span>
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline">Select &rarr;</a>
            </div>
          </div>
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              ...
              <h3 class="font-bold text-lg text-[#0a2540] mb-2">Severe Damage / Missing Wheels</h3>
              <p class="text-sm text-slate-600 leading-relaxed mb-6">
                Broken axles, missing wheels, or heavy structural damage. Loaded by Copart yard forklift onto dedicated flatbeds.
              </p>
            </div>
            <div class="pt-5 border-t border-slate-100 flex items-center justify-between">
              <span class="text-xs font-semibold text-slate-700 bg-slate-100 px-3 py-1 rounded-md">Flatbed / Heavy Haul</span>
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline">Select &rarr;</a>
            </div>
          </div>
      ...
      <!-- 7. Delivery Routes Grid (Proper Structured Cards) -->
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              ...
              <h3 class="font-bold text-lg text-[#0a2540] mb-2">Major Metro Hubs</h3>
              <p class="text-sm text-slate-600 leading-relaxed mb-6">
            ...
            <div class="pt-5 border-t border-slate-100">
              <a href="/cost-calculator/" class="text-xs font-bold text-[#635bff] hover:underline inline-flex items-center gap-1">
                Calculate metro route &rarr;
              </a>
            </div>
          </div>
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              ...
              <h3 class="font-bold text-lg text-[#0a2540] mb-2">Regional East Coast</h3>
              <p class="text-sm text-slate-600 leading-relaxed mb-6">
          ...
          <div class="p-7 sm:p-8 rounded-2xl border border-slate-200 bg-white transition-all duration-300 hover:shadow-lg hover:border-[#635bff]/40 hover:-translate-y-1 flex flex-col justify-between">
            <div>
              ...
              <h3 class="font-bold text-lg text-[#0a2540] mb-2">Ports &amp; Export Terminals</h3>
              <p class="text-sm text-slate-600 leading-relaxed mb-6">
...
console.log('✅ Generated polished boxes with clean footers and action buttons.');
