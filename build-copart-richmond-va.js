...
// Add custom CSS for card hover states & accordion styling
const customCss = `
  <style>
    .card-hover-indigo {
    ...
    details.faq-card[open] summary .faq-icon {
      transform: rotate(180deg);
      background-color: #635bff;
      color: #ffffff;
    }
    details.faq-card summary:hover .faq-icon {
      background-color: #e0e7ff;
      color: #4338ca;
    }
    details.faq-card[open] summary:hover .faq-icon {
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "To ship a car from Copart Richmond, win the auction and pay your invoice in full. Wait for payment to clear, retrieve your gate pass and lot details from your Copart portal, then book dispatch with Neon Auto Transport. We assign a verified carrier who schedules pickup via the Copart Transportation App and delivers your vehicle door-to-door."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Most Copart vehicles are salvage or inoperable. We dispatch winch-equipped carriers for vehicles that roll and steer, and coordinate forklift assistance at Copart Richmond for heavily damaged vehicles with broken axles or missing wheels."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "While not legally mandatory, using an FMCSA-licensed broker like Neon Auto Transport simplifies the process by matching Copart-approved carriers, managing gate pass appointments, ensuring cargo insurance coverage, and avoiding yard penalties."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Your assigned carrier needs your Copart Buyer Number, Lot Number, and Gate Pass / Release PIN. The driver provides their carrier DOT/MC credentials and photo ID at gate check-in at the Sandston or Charles City yard."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. We regularly handle multi-car loads (2 to 9 vehicles) from both Richmond yards for auto dealerships, body shops, and exporters with volume discount pricing."
          }
        }
      ]
    },
...
// ============================================================
// 2. MAIN CONTENT WITH REFINED STEP GUIDE & BEAUTIFUL FAQ ACCORDION
// ============================================================
const newMain = `<main class="bg-white min-h-screen text-[#0a2540]">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 space-y-24 lg:space-y-32">
      ...
      <!-- 3. Step-by-Step Guide: REFINED DYNAMIC 5-STAGE PROCESS LAYOUT -->
      <section class="pt-4" id="step-by-step-guide">
        ...
        <!-- Dynamic Process Grid: Top Pair, Featured Center Dispatch, Bottom Pair -->
        <div class="space-y-8">
          
          <!-- Stages 1 & 2 (2-Column Grid) -->
      ...
      <!-- 8. FAQ Section: REFINED CARD ACCORDION WITH COMPLETE SCHEMA VALIDATION -->
      <section class="pt-4" id="faq" itemscope itemtype="https://schema.org/FAQPage">
        <div class="mb-10 lg:mb-12">
          <div class="inline-flex items-center gap-2 px-3.5 py-1 bg-[#e0e7ff] text-[#4338ca] text-xs font-bold rounded-full mb-3">
            ❓ Copart Shipping FAQs
          </div>
          <h2 class="text-2xl sm:text-3xl font-black text-[#0a2540] tracking-tight mb-3">Frequently Asked Questions</h2>
          <p class="text-sm sm:text-base text-[#425466] leading-relaxed max-w-3xl font-medium">
            Answers to key questions regarding vehicle release, dispatch appointments, towing fees, and delivery from Copart Richmond.
          </p>
        </div>
        ...
        <div class="space-y-6">
          ...
          <!-- FAQ 1 -->
          <details class="faq-card bg-white p-7 sm:p-8 rounded-3xl card-hover-indigo group cursor-pointer transition-all duration-300" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" open>
            <summary class="font-black text-lg sm:text-xl text-[#0a2540] flex justify-between items-center list-none select-none">
              <span itemprop="name" class="pr-4">How do I ship a car from Copart Richmond VA?</span>
              <span class="faq-icon w-9 h-9 rounded-full bg-[#f0f5fa] text-[#4338ca] flex items-center justify-center text-sm font-bold transition-all duration-300 shrink-0">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M19 9l-7 7-7-7"/></svg>
              </span>
            </summary>
            <div class="mt-4 pt-4 border-t border-[#e6e6e6] text-[#425466] text-sm sm:text-base leading-relaxed font-medium" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">To ship a car from Copart Richmond, first pay your invoice in full. Once payment clears, retrieve your gate pass and lot number from your Copart portal. Contact Neon Auto Transport with your vehicle condition and delivery address. Our team assigns an authorized carrier who schedules a pickup appointment through the Copart Transportation App and delivers your vehicle door-to-door.</p>
            </div>
          </details>

          <!-- FAQ 2 -->
          <details class="faq-card bg-white p-7 sm:p-8 rounded-3xl card-hover-indigo group cursor-pointer transition-all duration-300" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            <summary class="font-black text-lg sm:text-xl text-[#0a2540] flex justify-between items-center list-none select-none">
            ...
            <div class="mt-4 pt-4 border-t border-[#e6e6e6] text-[#425466] text-sm sm:text-base leading-relaxed font-medium" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">Typical auto transport costs range from $300 to $1,500 for standard open carrier transport depending on distance. Inoperable vehicles requiring winch loading add $100–$250, while flatbed or heavy-haul transport ranges from $800 to $4,000+. Copart also charges a standard $50–$75 gate/loading fee.</p>
            </div>
          </details>
          ...
          <details class="faq-card bg-white p-7 sm:p-8 rounded-3xl card-hover-indigo group cursor-pointer transition-all duration-300" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="mt-4 pt-4 border-t border-[#e6e6e6] text-[#425466] text-sm sm:text-base leading-relaxed font-medium" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">Neon Auto Transport prioritizes same-day or 24–48 hour dispatch once payment clears and the gate pass is generated. Prompt pickup helps avoid Copart's daily yard storage fees ($30–$50+/day) after the free storage window expires.</p>
            </div>
          </details>
        ...
        <!-- FAQ Help Callout Box -->
        <div class="mt-8 p-6 bg-slate-50 border border-[#e6e6e6] rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
          <div class="text-center sm:text-left">
            <h3 class="font-bold text-[#0a2540] text-sm mb-1">Have a specific question about your Copart Richmond lot?</h3>
            <p class="text-xs text-[#425466]">Our auction logistics coordinators are ready to verify your gate status and provide a custom quote.</p>
          </div>
          <a href="tel:5715767711" class="px-6 py-2.5 bg-[#0a2540] hover:bg-[#163a5f] text-white text-xs font-bold rounded-xl transition whitespace-nowrap shadow-sm" style="text-decoration:none;">
            Speak to a Coordinator &rarr;
          </a>
        </div>
      </section>
...
console.log('✅ Generated refined Step-by-Step Flow and Clean FAQ Accordions with 100% Valid Schema.');
