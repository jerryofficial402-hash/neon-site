...
const customCss = `
  <style>
    ...
    .btn-green:hover {
      background-color: #32e011 !important;
    }
    ...
    .btn-purple:hover {
      background-color: #534be8 !important;
    }
  </style>
`;
...
// ============================================================
// 2. MAIN CONTENT WITH ROBUST INLINE STYLES FOR ALL BUTTONS
// ============================================================
const newMain = `<main class="bg-white min-h-screen text-[#0a2540]">
    ...
    <section class="border-b border-slate-200 bg-[#f8fafc] pt-32 pb-20 lg:pt-36 lg:pb-24">
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-12">
          ...
          <a href="tel:5715767711" style="background-color: #ffffff; color: #0a2540; font-weight: 800; text-decoration: none;" class="px-8 py-4 rounded-xl font-bold text-base border border-slate-300 hover:bg-slate-50 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5 text-center flex items-center justify-center gap-2">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 space-y-24 lg:space-y-32">
      ...
      <!-- 8. ULTRA-CLEAN, MODERN ACCORDION FAQ SECTION -->
      ...
      <!-- 9. Pre-Footer High-Impact CTA Banner (FIXED BULLETPROOF INLINE STYLING) -->
      <section style="background-color: #0a2540;" class="rounded-3xl p-10 sm:p-14 lg:p-16 text-center text-white shadow-2xl transition-all duration-300 hover:shadow-xl mt-12">
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
          ...
          <!-- Button 3: Golden Yellow Reviews Button (FIXED) -->
...
console.log('✅ Fixed Google Reviews CTA button styling and built page.');
