...
html = html.replace(
  /<title>[^<]*<\/title>/,
  '<title>Copart Richmond VA Car Shipping | Fast Pickup &amp; Delivery</title>'
);

// Meta description (150-160 chars)
html = html.replace(
  /<meta name="description" content="[^"]*">/,
  '<meta name="description" content="Ship cars from Copart Richmond VA (Sandston &amp; Charles City) with Neon Auto Transport. Fast dispatch, winch &amp; forklift loading, and insured door-to-door delivery.">'
);
...
html = html.replace(
  ...
  '<meta property="og:title" content="Copart Richmond VA Car Shipping | Fast Pickup &amp; Delivery">'
);

html = html.replace(
  /<meta property="og:description" content="[^"]*">/,
  '<meta property="og:description" content="Ship cars from Copart Richmond VA (Sandston &amp; Charles City) with Neon Auto Transport. Fast dispatch, winch &amp; forklift loading, and insured door-to-door delivery.">'
);

// Twitter
html = html.replace(
  /<meta name="twitter:title" content="[^"]*">/,
  '<meta name="twitter:title" content="Copart Richmond VA Car Shipping | Fast Pickup &amp; Delivery">'
);

html = html.replace(
  /<meta name="twitter:description" content="[^"]*">/,
  '<meta name="twitter:description" content="Ship cars from Copart Richmond VA (Sandston &amp; Charles City) with Neon Auto Transport. Fast dispatch, winch &amp; forklift loading, and insured door-to-door delivery.">'
);

// Add custom CSS for card hover states, sleek FAQ accordion, and button styling
const customCss = `
  <style>
    .card-hover-indigo {
...
// JSON-LD Multi-Entity Schema (LocalBusiness + Service + OfferCatalog + FAQPage + BreadcrumbList)
const newSchema = `<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    {
      "@type": "Service",
      "@id": "https://neonautotransport.com/copart-richmond-va-car-shipping/#service",
      ...
      "description": "Direct vehicle transport from Copart Richmond yards (Sandston and Charles City) to any location nationwide. We coordinate gate passes, app appointments, and inoperable vehicle loading.",
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Flatbed and forklift loading for heavy salvage"
            }
          }
        ]
      }
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "To ship a car from Copart Richmond, first pay your auction invoice in full using wire transfer, ePay, or debit. Once funds clear, retrieve your Gate Pass / Buyer PIN and confirm your yard location (Sandston #42 or Charles City #134). Book dispatch with Neon Auto Transport — our team assigns an authorized carrier who schedules a pickup window via the Copart Transportation App and delivers your vehicle door-to-door."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most shipments from Copart Richmond range from $300 to $1,500+ depending on distance and vehicle condition. Short regional moves (DC, Northern VA) often fall between $250–$400, while long-distance runs to Florida or Texas can reach $950–$1,800+. Non-running vehicles typically cost $100–$300 more due to winch or forklift loading."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Neon Auto Transport typically arranges same-day or next-day dispatch once your payment has cleared and your gate pass is issued. Faster pickup helps you avoid daily Copart storage fees that start after the 2–3 business day free window."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, you don’t legally need a broker, but using a broker like Neon Auto Transport saves time and reduces risk. We find Copart-approved carriers, handle gate pass coordination, and provide a single point of contact for tracking and issues."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Your carrier needs your Gate Pass / Buyer PIN, lot number, and yard location (Sandston or Charles City). The carrier must be registered in Copart’s system with a valid MC number and insurance; Neon Auto Transport handles this setup for you."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. If you’ve bought several vehicles from the Sandston or Charles City yards, we can consolidate them into a multi-car load and coordinate a single pickup window when possible. Volume pricing is available for dealers and rebuilders."
          }
        }
      ]
    },
...
// ============================================================
// 2. MAIN CONTENT WITH REFINED COPY, AEO BOXES, HEADINGS & SCHEMAS
// ============================================================
const newMain = `<main class="bg-white min-h-screen text-[#0a2540]">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-24 space-y-24 lg:space-y-32">
      ...
      <!-- 1. Quick Overview Box & AEO Direct Answer -->
      <section class="space-y-6" aria-label="Quick Overview">
        ...
        <div class="bg-white border border-slate-200 border-l-4 border-l-[#635bff] rounded-2xl p-6 shadow-sm">
          ...
          <p class="text-sm text-slate-700 leading-relaxed font-medium">
            To ship a car from Copart Richmond, pay your invoice in full, download your Gate Pass PIN from your Copart Member account, then book a Copart-approved carrier. Neon Auto Transport handles Copart Transportation App scheduling, gate coordination, and direct delivery to your home, auto repair shop, dealership, or maritime port.
          </p>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl card-hover-indigo" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
          ...
          <h2 class="text-2xl font-black text-[#0a2540] mb-3">Quick overview: Shipping from Copart Richmond, VA</h2>
          ...
          <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
            <a href="/cost-calculator/" style="background-color: #f0f5fa; color: #0a2540; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#0a2540] hover:text-white font-bold text-xs rounded-xl transition">
              Calculate Route Rate →
            </a>
            <a href="tel:5715767711" style="background-color: #ffc72c; color: #0a2540; font-weight: 900; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#e0b020] text-xs rounded-xl transition shadow-sm">
              Call (571) 576-7711
            </a>
          </div>
        </div>
      ...
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
          ...
          <p class="text-sm sm:text-base text-[#425466] leading-relaxed max-w-3xl font-medium mb-3">
            Generic auto haulers often reject auction pickups due to gate wait times, inoperable vehicle issues, or strict yard protocols. Our specialized auction team manages the entire release process from start to finish.
          </p>
          <p class="text-xs sm:text-sm text-[#4338ca] font-bold">
            🛡️ Neon Auto Transport is an FMCSA-licensed broker (MC #1703787 | USDOT #4355879) working with insured, auction-vetted carriers.
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="bg-white p-8 rounded-3xl card-hover-indigo flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            ...
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              ...
              <a href="/services/auto-auction-shipping/" style="background-color: #e0e7ff; color: #4338ca; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#4338ca] hover:text-white font-bold text-xs rounded-xl transition">
                Auction Hub →
              </a>
            </div>
          </div>
          ...
          <div class="bg-white p-8 rounded-3xl card-hover-green flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            ...
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              ...
              <a href="/services/auto-auction-shipping/" style="background-color: #39FF14; color: #0a2540; font-weight: 900; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#32e011] text-xs rounded-xl transition shadow-sm">
                Auction Services →
              </a>
            </div>
          </div>
      ...
      <section class="pt-4" id="step-by-step-guide">
        <div class="mb-10 lg:mb-12">
          ...
          <p class="text-sm sm:text-base text-[#425466] leading-relaxed max-w-3xl font-medium">
            Follow this step-by-step auction release protocol to prevent yard storage penalties and ensure safe, insured delivery. Read our companion <a href="/blog/how-to-ship-a-car-from-copart-richmond-va/" class="text-[#635bff] font-bold underline">Copart Richmond shipping guide</a> for in-depth insights.
          </p>
        </div>
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-3xl card-hover-indigo flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
              <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-[#0a2540] mb-2">Phase 01 • Payment – Win &amp; Complete Invoice Payment</h3>
            ...
            <div class="bg-white p-8 rounded-3xl card-hover-cyan flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
              <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-[#0a2540] mb-2">Phase 02 • Clearance – Obtain Gate Pass &amp; Verify Yard</h3>
                <p class="text-sm text-[#425466] leading-relaxed font-medium mb-6">
          ...
          <div class="bg-white p-8 sm:p-10 rounded-3xl card-hover-green" style="background:#ffffff; border:2px solid #39FF14; border-radius:1.5rem; box-shadow: 0 10px 25px rgba(57, 255, 20, 0.1);">
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              <div class="max-w-2xl">
                ...
                <h3 class="text-2xl sm:text-3xl font-black text-[#0a2540] mb-3">Phase 03 • Dispatch Booking – Book Dispatch with Neon Auto Transport</h3>
                <p class="text-sm sm:text-base text-[#425466] leading-relaxed font-medium">
                  Book Dispatch with Neon Auto Transport for Copart Richmond car shipping. Provide your Lot #, Buyer PIN, vehicle running status (operable, rolls/steers, or heavy salvage), and destination address. We immediately dispatch an FMCSA-authorized auto carrier with active $500,000 cargo insurance.
                </p>
              </div>
              
              <div class="flex flex-col sm:flex-row lg:flex-col gap-3 shrink-0">
                <a href="/cost-calculator/" style="background-color: #39FF14 !important; color: #0a2540 !important; font-weight: 900 !important; text-decoration: none !important; display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem;" class="px-8 py-3.5 rounded-xl text-sm hover:opacity-95 transition-all duration-300 shadow-[0_0_15px_rgba(57,255,20,0.3)] hover:-translate-y-0.5 text-center">
                  <span>Calculate &amp; Book Rate</span>
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                </a>
                <a href="tel:5715767711" style="background-color: #f0f5fa; color: #0a2540; font-weight: 700; text-decoration: none;" class="px-8 py-3.5 rounded-xl font-bold text-sm hover:bg-[#0a2540] hover:text-white transition-all duration-300 text-center">
                  Call (571) 576-7711
                </a>
              </div>
            </div>
          ...
          <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-3xl card-hover-indigo flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
              <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-[#0a2540] mb-2">Phase 04 • Yard Loading – Carrier App Check-In &amp; Loading</h3>
                <p class="text-sm text-[#425466] leading-relaxed font-medium mb-6">
            ...
            <div class="bg-white p-8 rounded-3xl card-hover-green flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
              <div>
                ...
                <h3 class="text-xl sm:text-2xl font-black text-[#0a2540] mb-2">Phase 05 • Delivery – Direct Door-to-Door Delivery</h3>
                <p class="text-sm text-[#425466] leading-relaxed font-medium mb-6">
      ...
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
          ...
          <h2 class="text-2xl sm:text-3xl font-black text-[#0a2540] tracking-tight mb-3">What Does Copart Richmond Car Shipping Cost?</h2>
          <p class="text-sm sm:text-base text-[#425466] leading-relaxed max-w-3xl font-medium">
            Estimated Copart Richmond car shipping rates based on distance and vehicle condition (running vs non-running).
          </p>
        </div>
        ...
        <div class="bg-white p-8 rounded-3xl card-hover-indigo" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            ...
            <table class="w-full text-left border-collapse text-sm">
              <thead>
                <tr class="bg-slate-100 text-[#0a2540] border-b border-slate-200">
                  <th scope="col" class="p-4 font-bold">Delivery Destination</th>
                  <th scope="col" class="p-4 font-bold">Distance</th>
                  <th scope="col" class="p-4 font-bold">Running (Open)</th>
                  <th scope="col" class="p-4 font-bold">Non-Running (Winch)</th>
          ...
          <div class="flex flex-wrap items-center justify-between gap-4 pt-4 border-t border-[#e6e6e6]">
            <p class="text-xs text-[#425466]">Note: Copart charges an additional $50–$75 gate/loading fee paid directly to the auction facility. Rates above are for transport only and do not include Copart yard fees.</p>
      ...
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
          ...
          <h2 class="text-2xl sm:text-3xl font-black text-[#0a2540] tracking-tight mb-3">Understand the Two Copart Richmond Yard Locations</h2>
          <p class="text-sm sm:text-base text-[#425466] leading-relaxed max-w-3xl font-medium">
            Copart operates two primary auction facilities in the Richmond area. Always check your invoice to confirm whether your vehicle is at the Sandston or Charles City yard.
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          ...
          <!-- Yard 1: Sandston -->
          <div class="copart-yard bg-white p-8 rounded-3xl card-hover-indigo flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            <div>
              <div class="inline-flex items-center gap-2 px-3 py-1 bg-[#e0e7ff] text-[#4338ca] text-xs font-bold rounded-full mb-4">
                📍 Virginia Location &bull; Yard #42
              </div>
              <h3 class="text-2xl font-black text-[#0a2540] mb-1">Copart – Richmond (Sandston) – Yard #42</h3>
            ...
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              <a href="https://maps.google.com/?q=5701+Whiteside+Rd,+Sandston,+VA+23150" target="_blank" rel="noopener noreferrer" style="background-color: #f0f5fa; color: #0a2540; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#0a2540] hover:text-white font-bold text-xs rounded-xl transition">
                Get Directions →
              </a>
              <a href="tel:8043281023" style="background-color: #ffc72c; color: #0a2540; font-weight: 900; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#e0b020] text-xs rounded-xl transition shadow-sm">
                Call Yard Direct 📞
              </a>
              <a href="/cost-calculator/" style="background-color: #e0e7ff; color: #4338ca; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#4338ca] hover:text-white font-bold text-xs rounded-xl transition">
          ...
          <!-- Yard 2: Charles City -->
          <div class="copart-yard bg-white p-8 rounded-3xl card-hover-cyan flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            <div>
              <div class="inline-flex items-center gap-2 px-3 py-1 bg-[#ecfeff] text-[#0891b2] text-xs font-bold rounded-full mb-4">
                📍 Virginia Location &bull; Yard #134
              </div>
              <h3 class="text-2xl font-black text-[#0a2540] mb-1">Copart – Richmond East (Charles City) – Yard #134</h3>
              <p class="text-xs font-bold text-[#0891b2] mb-3">East Richmond Facility</p>
              <p class="text-sm text-[#425466] leading-relaxed mb-4 font-medium">
            ...
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              <a href="https://maps.google.com/?q=6300+Chambers+Road,+Charles+City,+VA+23030" target="_blank" rel="noopener noreferrer" style="background-color: #f0f5fa; color: #0a2540; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#0a2540] hover:text-white font-bold text-xs rounded-xl transition">
                Get Directions →
              </a>
              <a href="tel:8048299160" style="background-color: #ffc72c; color: #0a2540; font-weight: 900; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#e0b020] text-xs rounded-xl transition shadow-sm">
                Call Yard Direct 📞
              </a>
              <a href="/cost-calculator/" style="background-color: #39FF14; color: #0a2540; font-weight: 900; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#32e011] text-xs rounded-xl transition shadow-sm">
      ...
      <section class="pt-4">
        <div class="mb-10 lg:mb-12">
          ...
          <h2 class="text-2xl sm:text-3xl font-black text-[#0a2540] tracking-tight mb-3">Shipping Inoperable &amp; Damaged Vehicles</h2>
          <p class="text-sm sm:text-base text-[#425466] leading-relaxed max-w-3xl font-medium">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div class="bg-white p-8 rounded-3xl card-hover-indigo flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            ...
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              ...
              <a href="tel:5715767711" style="background-color: #e0e7ff; color: #4338ca; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#4338ca] hover:text-white font-bold text-xs rounded-xl transition">
                Book Now →
              </a>
            </div>
          </div>
          ...
          <div class="bg-white p-8 rounded-3xl card-hover-cyan flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            <div>
              ...
              <p class="text-sm text-[#425466] leading-relaxed mb-6 font-medium">
                Non-running engine or mechanical failure, but tires hold air and steering works properly for winch loading.
              </p>
            </div>
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              <a href="/cost-calculator/" style="background-color: #f0f5fa; color: #0a2540; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#0a2540] hover:text-white font-bold text-xs rounded-xl transition">
          ...
          <div class="bg-white p-8 rounded-3xl card-hover-green flex flex-col justify-between" style="background:#ffffff; border:1px solid #e6e6e6; border-radius:1.5rem;">
            <div>
              ...
              <p class="text-sm text-[#425466] leading-relaxed mb-6 font-medium">
                Broken axles, missing wheels, or heavy structural damage. Loaded by Copart’s heavy yard forklift onto flatbed transport.
              </p>
            </div>
            <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e6e6e6]">
              <a href="/cost-calculator/" style="background-color: #f0f5fa; color: #0a2540; font-weight: 700; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#0a2540] hover:text-white font-bold text-xs rounded-xl transition">
              ...
              <a href="tel:5715767711" style="background-color: #39FF14; color: #0a2540; font-weight: 900; text-decoration: none;" class="px-5 py-2.5 hover:bg-[#32e011] text-xs rounded-xl transition shadow-sm">
                Heavy Haul Quote →
              </a>
            </div>
          </div>
      ...
      <!-- 8. ULTRA-CLEAN, MODERN ACCORDION FAQ SECTION (7 Full Answers + Valid Schema) -->
        ...
        <div class="space-y-4">
          ...
          <details class="faq-item bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/90 shadow-sm transition-all duration-300 hover:border-[#635bff]/40 hover:shadow group cursor-pointer" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" open>
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-slate-600 text-sm sm:text-base leading-relaxed" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">To ship a car from Copart Richmond, first pay your auction invoice in full using wire transfer, ePay, or debit. Once funds clear, retrieve your Gate Pass / Buyer PIN and confirm your yard location (Sandston #42 or Charles City #134). Book dispatch with Neon Auto Transport — our team assigns an authorized carrier who schedules a pickup window via the Copart Transportation App and delivers your vehicle door-to-door.</p>
            </div>
          </details>
          ...
          <details class="faq-item bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/90 shadow-sm transition-all duration-300 hover:border-[#635bff]/40 hover:shadow group cursor-pointer" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-slate-600 text-sm sm:text-base leading-relaxed" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">Most shipments from Copart Richmond range from $300 to $1,500+ depending on distance and vehicle condition. Short regional moves (DC, Northern VA) often fall between $250–$400, while long-distance runs to Florida or Texas can reach $950–$1,800+. Non-running vehicles typically cost $100–$300 more due to winch or forklift loading.</p>
            </div>
          </details>
          ...
          <details class="faq-item bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/90 shadow-sm transition-all duration-300 hover:border-[#635bff]/40 hover:shadow group cursor-pointer" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-slate-600 text-sm sm:text-base leading-relaxed" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">Neon Auto Transport typically arranges same-day or next-day dispatch once your payment has cleared and your gate pass is issued. Faster pickup helps you avoid daily Copart storage fees that start after the 2–3 business day free window.</p>
            </div>
          </details>
          ...
          <details class="faq-item bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/90 shadow-sm transition-all duration-300 hover:border-[#635bff]/40 hover:shadow group cursor-pointer" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-slate-600 text-sm sm:text-base leading-relaxed" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">No, you don’t legally need a broker, but using a broker like Neon Auto Transport saves time and reduces risk. We find Copart-approved carriers, handle gate pass coordination, and provide a single point of contact for tracking and issues.</p>
            </div>
          </details>
          ...
          <details class="faq-item bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/90 shadow-sm transition-all duration-300 hover:border-[#635bff]/40 hover:shadow group cursor-pointer" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-slate-600 text-sm sm:text-base leading-relaxed" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">Your carrier needs your Gate Pass / Buyer PIN, lot number, and yard location (Sandston or Charles City). The carrier must be registered in Copart’s system with a valid MC number and insurance; Neon Auto Transport handles this setup for you.</p>
            </div>
          </details>
          ...
          <details class="faq-item bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/90 shadow-sm transition-all duration-300 hover:border-[#635bff]/40 hover:shadow group cursor-pointer" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="mt-4 pt-4 border-t border-slate-100 text-slate-600 text-sm sm:text-base leading-relaxed" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
              <p itemprop="text">Yes. If you’ve bought several vehicles from the Sandston or Charles City yards, we can consolidate them into a multi-car load and coordinate a single pickup window when possible. Volume pricing is available for dealers and rebuilders.</p>
            </div>
          </details>
      ...
      <!-- 9. Pre-Footer High-Impact CTA Banner with Urgency Hook -->
      <section style="background-color: #0a2540;" class="rounded-3xl p-10 sm:p-14 lg:p-16 text-center text-white shadow-2xl transition-all duration-300 hover:shadow-xl mt-12">
        ...
        <p class="text-[#ffc72c] text-xs sm:text-sm font-bold mb-10 max-w-xl mx-auto">
          ⚠️ Book within 24 hours of payment to maximize your free storage window and avoid daily Copart fees.
        </p>
...
console.log('✅ Applied all 11 SEO, AEO, content, schema, and conversion tweaks to main service page.');
