...
const outDir = path.join(rootDir, 'car-shipping-arlington-va');
...
html = html.replace(
  /<title>.*?<\/title>/g,
  '<title>Car Shipping Arlington VA | Auto Transport | Neon Auto Transport</title>'
);

html = html.replace(
  /<meta name="description" content=".*?">/g,
  '<meta name="description" content="Local car shipping company in Arlington, VA. Open & enclosed auto transport, zero deposit, FMCSA licensed. Serving Northern Virginia. Free instant quote.">'
);

html = html.replace(
  /<link rel="canonical" href=".*?">/g,
  '<link rel="canonical" href="https://neonautotransport.com/car-shipping-arlington-va/">'
);

html = html.replace(
  /<meta property="og:title" content=".*?">/g,
  '<meta property="og:title" content="Car Shipping Arlington VA | Auto Transport | Neon Auto Transport">'
);

html = html.replace(
  /<meta property="og:description" content=".*?">/g,
  '<meta property="og:description" content="Local car shipping company in Arlington, VA. Open & enclosed auto transport, zero deposit, FMCSA licensed. Serving Northern Virginia. Free instant quote.">'
);

html = html.replace(
  /<meta property="og:url" content=".*?">/g,
  '<meta property="og:url" content="https://neonautotransport.com/car-shipping-arlington-va/">'
);
...
html = html.replace(
  ...
  '<meta name="twitter:title" content="Car Shipping Arlington VA | Auto Transport | Neon Auto Transport">'
);

html = html.replace(
  /<meta name="twitter:description" content=".*?">/g,
  '<meta name="twitter:description" content="Local car shipping company in Arlington, VA. Open & enclosed auto transport, zero deposit, FMCSA licensed. Serving Northern Virginia. Free instant quote.">'
);
  ...
  "@graph": [
    {
      ...
      "url": "https://neonautotransport.com/car-shipping-arlington-va/",
      ...
      "areaServed": [
        ...
        { "@type": "City", "name": "Clarendon, VA" },
        { "@type": "City", "name": "Ballston, VA" },
        { "@type": "City", "name": "Rosslyn, VA" },
        { "@type": "City", "name": "Crystal City, VA" },
        { "@type": "City", "name": "Pentagon City, VA" }
      ],
      "priceRange": "$$"
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "How much does it cost to ship a car from Arlington, VA?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Car shipping from Arlington typically costs between $1.00 and $1.40 per mile for open transport. A short regional route like Arlington to New York costs $500-$650. A cross-country route to California costs $1,250-$1,650."
          }
        },
        {
          "@type": "Question",
          "name": "How long does it take to ship a car from Arlington?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Transit time depends on distance. Regional East Coast routes take 1-2 days. Mid-range routes like Arlington to Texas take 3-5 days. Cross-country routes to California take 6-9 days."
          }
        },
        {
          "@type": "Question",
          "name": "Do you offer door-to-door pickup in Arlington neighborhoods like Ballston and Rosslyn?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. We provide door-to-door pickup throughout Arlington, including Clarendon, Ballston, Rosslyn, Crystal City, Pentagon City, and Shirlington."
          }
        },
        {
          "@type": "Question",
          "name": "Do I need to pay a deposit to ship my car from Arlington?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "Can you ship a car for military PCS orders from the Pentagon or Fort Myer?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. We provide priority scheduling for military families assigned to the Pentagon, Fort Myer (Joint Base Myer-Henderson Hall), and Henderson Hall, working strictly around your PCS reporting date."
          }
        }
      ]
    }
    ...
    <section class="relative bg-[#0a2540] pt-32 pb-40 overflow-hidden" style="clip-path: polygon(0 0, 100% 0, 100% 90%, 0 100%);">
      ...
      <div class="container mx-auto px-4 relative z-10 text-center max-w-4xl">
        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-[#39FF14] font-bold text-sm tracking-wide mb-8 animate-fadeIn" style="animation-delay: 0.1s;">
          <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg> Arlington, VA
        </div>
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] tracking-tight mb-8 drop-shadow-lg animate-fadeIn" style="animation-delay: 0.2s;">
          Car Shipping in Arlington, VA — <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#00d4ff] to-[#635bff]">Your Local Auto Transport Company</span>
        </h1>
    ...
    <section class="py-20 bg-[#f8fafc] -mt-16 relative z-10">
      <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="stripe-card bg-white p-8 md:p-12 rounded-2xl shadow-xl mb-12">
          <h2 class="text-3xl font-bold text-[#0a2540] mb-6 tracking-tight">Why Choose Neon Auto Transport for Arlington Car Shipping?</h2>
          <p class="text-lg text-[#425466] leading-relaxed mb-4">
            Shipping a car out of Arlington requires understanding the specific logistics of Northern Virginia. The dense traffic along I-66, the HOV lane restrictions on I-395, and the narrow residential streets of neighborhoods like Clarendon and Rosslyn present unique challenges for standard 80-foot auto transport carriers.
          </p>
          <p class="text-lg text-[#425466] leading-relaxed">
            As a local transport company headquartered nearby in Northern Virginia, we have a dense network of vetted, FMCSA-approved carriers who regularly navigate the Arlington and Washington D.C. metropolitan area. We know how to coordinate safe and compliant pickups in high-density areas, ensuring a smooth handoff without putting you or your vehicle at risk.
          </p>
        </div>

        <!-- Section: Car Shipping Cost -->
        <div class="stripe-card bg-white p-8 md:p-12 rounded-2xl shadow-xl mb-12">
          <h2 class="text-3xl font-bold text-[#0a2540] mb-6 tracking-tight">Car Shipping Cost from Arlington, VA</h2>
          <p class="text-lg text-[#425466] leading-relaxed mb-8">
            Arlington auto transport typically costs between $1.00 and $1.40 per mile for short to mid-range trips, and around $0.60 per mile for cross-country moves. Here is what that means for the most common routes departing from Arlington:
          </p>
            ...
            <table class="w-full text-left border-collapse">
              ...
              <tbody class="divide-y divide-[#e6e6e6]">
                <tr class="hover:bg-[#f8fafc] transition-colors">
                  ...
                  <td class="p-4 text-[#425466]">~900 mi</td>
                ...
                <tr class="hover:bg-[#f8fafc] transition-colors">
                  ...
                  <td class="p-4 text-[#425466]">~230 mi</td>
                  <td class="p-4 text-[#0a2540] font-bold text-[#635bff]">$500 – $650</td>
                  <td class="p-4 text-[#425466]">1–2 days</td>
                </tr>
                <tr class="hover:bg-[#f8fafc] transition-colors">
                  <td class="p-4 text-[#0a2540] font-semibold">North Carolina</td>
                  <td class="p-4 text-[#425466]">~250 mi</td>
                  <td class="p-4 text-[#0a2540] font-bold text-[#635bff]">$500 – $650</td>
                  <td class="p-4 text-[#425466]">1–2 days</td>
                </tr>
                <tr class="hover:bg-[#f8fafc] transition-colors">
                  <td class="p-4 text-[#0a2540] font-semibold">Texas</td>
                  <td class="p-4 text-[#425466]">~1,350 mi</td>
                ...
                <tr class="hover:bg-[#f8fafc] transition-colors">
                  ...
                  <td class="p-4 text-[#425466]">~600 mi</td>
          ...
          <p class="text-lg text-[#425466] leading-relaxed">
            Most Arlington auto transport shipments fall between $500 and $1,200 for popular routes. <a href="/cost-calculator/" class="text-[#635bff] font-bold hover:underline">Get an exact quote for your specific route using our instant calculator.</a>
          </p>
        </div>

        <!-- Section: Neighborhoods We Serve -->
        <div class="stripe-card bg-white p-8 md:p-12 rounded-2xl shadow-xl mb-12">
          <h2 class="text-3xl font-bold text-[#0a2540] mb-6 tracking-tight">Neighborhoods We Serve in Arlington</h2>
          <p class="text-lg text-[#425466] leading-relaxed mb-6">
            Neon Auto Transport provides door-to-door pickup throughout Arlington and the surrounding Northern Virginia area, including:
          </p>
          <div class="flex flex-wrap gap-3 mb-8">
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Clarendon</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Ballston</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Rosslyn</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Crystal City</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Pentagon City</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Shirlington</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Virginia Square</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Courthouse</span>
            <span class="px-4 py-2 bg-[#f0f5fa] text-[#0a2540] font-bold rounded-lg border border-[#e6e6e6]">Fairlington</span>
          </div>
        ...
        <div class="stripe-card bg-white p-8 md:p-12 rounded-2xl shadow-xl mb-12">
          <h2 class="text-3xl font-bold text-[#0a2540] mb-6 tracking-tight">Open vs. Enclosed Transport in Arlington</h2>
          <p class="text-lg text-[#425466] leading-relaxed mb-8">
            Arlington sees a high volume of both standard commuters and luxury vehicles. We offer both open and enclosed carrier options to match your vehicle's needs.
          </p>
          <div class="grid md:grid-cols-2 gap-6">
            <div class="border border-[#e6e6e6] rounded-xl p-6 bg-[#f8fafc]">
              ...
              <p class="text-[#425466] leading-relaxed">
                Open transport is the standard, most affordable option for shipping a standard vehicle from Arlington — ideal for sedans, SUVs, and trucks in everyday condition.
              </p>
            </div>
            <div class="border border-[#e6e6e6] rounded-xl p-6 bg-[#f8fafc]">
              <h3 class="text-xl font-bold text-[#0a2540] mb-3 flex items-center gap-2">
              ...
              <p class="text-[#425466] leading-relaxed">
                Enclosed transport is recommended for Arlington residents shipping luxury, classic, or high-value vehicles, providing full protection from weather, road debris, and winter road salt on the highway.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="stripe-card bg-white p-8 md:p-12 rounded-2xl shadow-xl mb-12">
          <h2 class="text-3xl font-bold text-[#0a2540] mb-6 tracking-tight">Military PCS Car Shipping from Arlington</h2>
          <p class="text-lg text-[#425466] leading-relaxed">
            Home to The Pentagon, Fort Myer (Joint Base Myer-Henderson Hall), and Henderson Hall, Arlington has one of the highest concentrations of military personnel in the country. Neon Auto Transport provides priority scheduling for active duty military and veterans managing PCS moves. We work strictly around your reporting date and can coordinate pickup directly from your Arlington residence or base housing.
          </p>
        </div>

        <!-- Section: How It Works -->
        <div class="stripe-card p-8 lg:p-10 bg-white shadow-xl rounded-2xl mb-12 border-t-4 border-t-[#00d4ff]">
          <h2 class="text-3xl font-bold mb-8 text-[#0a2540] tracking-tight text-center">How to Ship a Car From Arlington, VA — 3 Steps</h2>
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="relative bg-[#f8fafc] p-6 rounded-xl border border-[#e6e6e6] hover:shadow-md transition text-center">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">Enter your Arlington ZIP code and destination. Get a locked-in price in under 30 seconds.</p>
            </div>
            ...
            <div class="relative bg-[#f8fafc] p-6 rounded-xl border border-[#e6e6e6] hover:shadow-md transition text-center">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">We match your shipment to an FMCSA-verified carrier. You pay nothing until a carrier is confirmed.</p>
            </div>
            ...
            <div class="relative bg-[#f8fafc] p-6 rounded-xl border border-[#e6e6e6] hover:shadow-md transition text-center">
              ...
              <p class="text-sm text-[#425466] leading-relaxed">Your carrier arrives at your Arlington address, completes a Bill of Lading inspection, and delivers your vehicle door-to-door at the destination.</p>
            </div>
          </div>
        ...
        <div class="stripe-card bg-white p-8 md:p-12 rounded-2xl shadow-xl mb-12" itemscope itemtype="https://schema.org/FAQPage">
          <h2 class="text-3xl font-bold text-[#0a2540] mb-8 tracking-tight">Arlington, VA Car Shipping FAQs</h2>
          ...
          <div class="space-y-4">
            <details class="group bg-[#f8fafc] rounded-lg border border-[#e6e6e6] open:border-[#e6e6e6] open:bg-white open:shadow-md transition-all duration-300" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <summary class="flex justify-between items-center font-bold cursor-pointer list-none p-6 text-[#0a2540] hover:text-[#635bff] transition-colors">
                <span itemprop="name">How much does it cost to ship a car from Arlington, VA?</span>
              ...
              <div class="text-[#425466] px-6 pb-6" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Car shipping from Arlington typically costs between $1.00 and $1.40 per mile for open transport. A short regional route like Arlington to New York costs $500–$650. A cross-country route to California costs $1,250–$1,650.</p>
              </div>
            </details>

            <details class="group bg-[#f8fafc] rounded-lg border border-[#e6e6e6] open:border-[#e6e6e6] open:bg-white open:shadow-md transition-all duration-300" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <summary class="flex justify-between items-center font-bold cursor-pointer list-none p-6 text-[#0a2540] hover:text-[#635bff] transition-colors">
                <span itemprop="name">How long does it take to ship a car from Arlington?</span>
                <span class="transition group-open:rotate-180">
                  <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                </span>
              </summary>
              <div class="text-[#425466] px-6 pb-6" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Transit time depends on distance. Regional East Coast routes take 1–2 days. Mid-range routes like Arlington to Texas take 3–5 days. Cross-country routes to California take 6–9 days.</p>
              </div>
            </details>

            <details class="group bg-[#f8fafc] rounded-lg border border-[#e6e6e6] open:border-[#e6e6e6] open:bg-white open:shadow-md transition-all duration-300" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <summary class="flex justify-between items-center font-bold cursor-pointer list-none p-6 text-[#0a2540] hover:text-[#635bff] transition-colors">
                <span itemprop="name">Do you offer door-to-door pickup in Arlington neighborhoods like Ballston and Rosslyn?</span>
                <span class="transition group-open:rotate-180">
                  <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                </span>
              </summary>
              <div class="text-[#425466] px-6 pb-6" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Yes. We provide door-to-door pickup throughout Arlington, including Clarendon, Ballston, Rosslyn, Crystal City, Pentagon City, and Shirlington.</p>
              </div>
            </details>
            
            <details class="group bg-[#f8fafc] rounded-lg border border-[#e6e6e6] open:border-[#e6e6e6] open:bg-white open:shadow-md transition-all duration-300" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <summary class="flex justify-between items-center font-bold cursor-pointer list-none p-6 text-[#0a2540] hover:text-[#635bff] transition-colors">
                <span itemprop="name">Do I need to pay a deposit to ship my car from Arlington?</span>
                <span class="transition group-open:rotate-180">
                  <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                </span>
              </summary>
            ...
            <details class="group bg-[#f8fafc] rounded-lg border border-[#e6e6e6] open:border-[#e6e6e6] open:bg-white open:shadow-md transition-all duration-300" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
              <summary class="flex justify-between items-center font-bold cursor-pointer list-none p-6 text-[#0a2540] hover:text-[#635bff] transition-colors">
                <span itemprop="name">Can you ship a car for military PCS orders from the Pentagon or Fort Myer?</span>
                <span class="transition group-open:rotate-180">
                  <svg fill="none" height="24" shape-rendering="geometricPrecision" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" width="24"><path d="M6 9l6 6 6-6"></path></svg>
                </span>
              </summary>
              <div class="text-[#425466] px-6 pb-6" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Yes. We provide priority scheduling for military families assigned to the Pentagon, Fort Myer (Joint Base Myer-Henderson Hall), and Henderson Hall, working strictly around your PCS reporting date.</p>
              </div>
            </details>
          </div>
        </div>
        ...
        <section class="mt-16 bg-[#0a2540] rounded-3xl p-10 md:p-16 text-center relative overflow-hidden shadow-2xl mb-12">
          ...
          <div class="relative z-10 max-w-2xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-black text-white mb-6">Ship Your Car from Arlington Today</h2>
...
html = html.replace(
  '<li><a href="/car-shipping-woodbridge-va/" class="group" style="color: #8ba3ba; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: all 0.3s;"',
  `<li><a href="/car-shipping-arlington-va/" class="group" style="color: #8ba3ba; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: all 0.3s;" onmouseover="this.style.color='#ffffff'; this.style.transform='translateX(4px)';" onmouseout="this.style.color='#8ba3ba'; this.style.transform='translateX(0)';"><svg style="width: 14px; height: 14px; color: #00D1FF;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg> Car Shipping Arlington VA</a></li>
            <li><a href="/car-shipping-woodbridge-va/" class="group" style="color: #8ba3ba; text-decoration: none; display: flex; align-items: center; gap: 0.5rem; transition: all 0.3s;"`
);
...
console.log('Arlington VA page built successfully!');
